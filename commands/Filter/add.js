...
module.exports = {
	...
	description: "Pievieno filtru Filtriem", //the command description for Slash Command Overview
	cooldown: 5,
				...
				if (filters.some(a => !FiltersSettings[a])) {
					return message.reply({
						embeds: [
							...
							.setColor(ee.wrongcolor)
							.setFooter(ee.footertext, ee.footericon)
							.setTitle(`${client.allEmojis.x} **Tu pievienoji vismaz vienu filtru kurš ir nepareizs!**`)
